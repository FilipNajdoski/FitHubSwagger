...
namespace FitHubApplication.Models.Migrations
{
    ...
    [Migration("20210810145142_AddedGroupTrainees")]
    partial class AddedGroupTrainees
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitHubApplication.Models.Entities.GroupTrainee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FitHubApplication.Models.Entities.GroupTrainee", b =>
                {
                    b.HasOne("FitHubApplication.Models.Entities.Group", "Group")
                        .WithMany("GroupTrainees")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FitHubApplication.Models.Entities.User", "Trainee")
                        .WithMany()
