...
namespace FitHubApplication.Models.Constants
{
    public static class ApplicationConsts
    {
        public static class ConfigConsts
        {
            ...
            public const string JwtSecurityKey = "JwtBearer:SecurityKey";

            public const string JwtIssuer = "JwtBearer:Issuer";
        ...
        public static class LogConsts
        {
            ...
            public const string FithubLogsPath = @"C:\FitHubLogs\";
        ...
        {
            public const string SwaggerRedirection = "~/swagger";

            public const string SwaggerJsonPath = "v1/swagger.json";

            public const string SwaggerDocs = "FitHub Docs";

            public const string FitHubAPI = "FitHubAPI";
